...
export const sendSlackMessage = async (dtClient: _OAuthHttpClient, connectionId: string, channel: string, message: string) => {
  const response = await callAppFunction(dtClient,
